   ...
   const Position& ptUpperRight)
{
   ...
   glClearColor(0.529f, 0.808f, 0.922f, 1.0f);  // RGB for light sky blue
   gluOrtho2D(0, (int)ptUpperRight.getPixelsX(), 0, (int)ptUpperRight.getPixelsY());   // range of y values: (0, height)
